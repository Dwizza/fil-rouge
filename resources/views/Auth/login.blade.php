...
<html lang="en">
  ...
  <body class="m-0 font-poppins antialiased font-normal bg-gradient-to-br from-orange-50 to-white text-start text-base leading-normal text-gray-700">
    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div class="max-w-7xl w-full flex flex-row-reverse rounded-3xl overflow-hidden shadow-2xl animate-fade-in-up">
        <!-- Login Form Column -->
        <div class="w-full lg:w-5/12 glass-effect p-10">
          ...
          <p class="mt-8 text-center text-sm text-gray-600">
            ...
            <a href="/register" class="font-medium text-primary-600 hover:text-primary-500 hover:underline">
              Sign up now
            </a>
          </p>
        </div>
        ...
        <!-- Image & Brand Column -->
        <div class="hidden lg:block w-7/12 animated-gradient rounded-l-3xl relative">
          <div class="absolute inset-0 flex flex-col justify-center px-12 text-white">
            <div class="max-w-lg">
              <h1 class="text-4xl font-bold mb-6">Start your journey with us today</h1>
              <p class="text-lg mb-8 opacity-90">Discover the best opportunities and services tailored for you.</p>
              ...
              <div class="space-y-6">
                <div class="flex items-center">
                  ...
                  <p class="ml-4 text-sm opacity-90">Secure and reliable platform for all your needs</p>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <p class="ml-4 text-sm opacity-90">Join thousands of satisfied users</p>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <p class="ml-4 text-sm opacity-90">Fast and efficient service delivery</p>
                </div>
              </div>
            </div>
