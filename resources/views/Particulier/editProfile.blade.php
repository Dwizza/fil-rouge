        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="bg-white shadow-lg rounded-2xl overflow-hidden">
                    ...
                    <div class="absolute top-28 inset-x-0 flex justify-center">
                        <div class="relative">
                            <div class="w-32 h-32 rounded-full border-4 border-white bg-white overflow-hidden">
                                <img id="preview-image" src="{{ auth()->user()->profile_photo ? asset('storage/'.auth()->user()->profile_photo) : 'https://ui-avatars.com/api/?name='.urlencode(auth()->user()->name).'&background=random' }}" 
                            ...
                            <label for="profile_photo" class="absolute bottom-0 right-0 w-10 h-10 bg-amber-500 rounded-full border-4 border-white flex items-center justify-center cursor-pointer hover:bg-amber-600 transition-colors duration-300">
                                ...
                                <input type="file" id="profile_photo" name="profile_photo" class="hidden" accept="image/*" onchange="previewImage()">
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 px-6 py-4 flex items-center justify-end gap-4">
                    <a href="" class="py-3 px-6 bg-white text-gray-700 font-medium border border-gray-300 rounded-lg shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-all duration-300">
                        Annuler
                    </a>
