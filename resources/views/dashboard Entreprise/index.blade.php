...
<div class="w-full px-6 py-6 mx-auto dark">
  ...
  <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4">
    <div class="relative flex flex-col min-w-0 break-words bg-slate-850 shadow-dark-xl rounded-2xl bg-clip-border">
    <div class="flex-auto p-4">
      ...
      <div class="flex-none w-2/3 max-w-full px-3">
        ...
        <p class="mb-0 text-white opacity-60">
  ...
  <div class="w-full max-w-full px-3 sm:w-1/2 sm:flex-none xl:w-1/4">
    ...
    <div class="flex-auto p-4">
      ...
      <div class="flex-none w-2/3 max-w-full px-3">
        <div>
        <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase text-white opacity-60">Sales</p>
  ...
  <div class="w-full max-w-full px-3 mt-0 lg:w-7/12 lg:flex-none">
    <div class="bg-slate-850 shadow-dark-xl relative z-20 flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-clip-border">
    <div class="mb-0 rounded-t-2xl border-b-0 border-solid p-6 pt-4 pb-0">
      <h6 class="capitalize text-white">Sales overview</h6>
      <p class="mb-0 text-sm leading-normal text-white opacity-60">
  ...
  <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
    <div slider class="relative w-full h-full overflow-hidden rounded-2xl bg-slate-850">
    <!-- slide 1 -->
